...
public class MixinBlock {
    ...
    public static boolean topCoversMediumSquare(BlockView world, BlockPos pos) {
        ...
        if (shapeCache != null) {
            return ((ExtendedBlockShapeCache) (Object) shapeCache).sideCoversMediumSquare(Direction.UP);
        }
    ...
    public static boolean isSolidSmallSquare(CollisionView world, BlockPos pos, Direction side) {
        ...
        if (shapeCache != null) {
            return ((ExtendedBlockShapeCache) (Object) shapeCache).sideCoversSmallSquare(side);
        }
