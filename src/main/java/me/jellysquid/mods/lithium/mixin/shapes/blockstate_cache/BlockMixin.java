...
public abstract class BlockMixin {
    ...
    public static boolean hasTopRim(BlockView world, BlockPos pos) {
        ...
        BlockShapeCacheExtended shapeCache = ((BlockShapeCacheExtendedProvider) state).lithium$getExtendedShapeCache();

        if (shapeCache != null) {
            return shapeCache.lithium$hasTopRim();
        }
    ...
    public static boolean sideCoversSmallSquare(WorldView world, BlockPos pos, Direction side) {
        ...
        if (shapeCache != null) {
            return shapeCache.lithium$sideCoversSmallSquare(side);
        }
